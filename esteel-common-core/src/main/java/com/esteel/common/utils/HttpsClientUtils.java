 ...
 * @see SSLException: hostname in certificate didn't match: <123.125.97.66> !=
 * <123.125.97.241>
...
public class HttpsClientUtils {
    ...
    public static String sendGetRequest(String reqURL) {
        ...
        try {
            ...
            logger.debug("HTTP应答完整报文=[{}\r\n{}\r\n\r\n{}]", respStatusLine, respHeaderMsg, respBodyMsg);
            logger.debug("-------------------------------------------------------------------------------------------");
    ...
    public static String sendPostRequest(String reqURL, String reqData,
        String contentType, String encodeCharset) {
    ...
    public static String sendGetSSLRequest(String reqURL, Map<String, String> params, String contentType, String encodeCharset) {
        ...
        try {
            ...
            HttpGet httpGet = new HttpGet(reqURL + paramStr);
    ...
    public static String sendGetSSLRequest(String reqURL, Map<String, String> params, String contentType, String encodeCharset, Integer socket_time) {
        String responseContent = "通信失败";
        HttpClient httpClient = new DefaultHttpClient();
        httpClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, socket_time);
        httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, socket_time);
        // 创建TrustManager()
        // 用于解决javax.net.ssl.SSLPeerUnverifiedException: peer not authenticated
        X509TrustManager trustManager = new X509TrustManager() {
            @Override
    ...
    public static String sendPostSSLRequest(String reqURL, Integer timout, String contentType, String encodeCharset, String message) {
        String responseContent = "通信失败";
        HttpClient httpClient = new DefaultHttpClient();
        httpClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, timout);
        httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, timout);
        // 创建TrustManager()
        // 用于解决javax.net.ssl.SSLPeerUnverifiedException: peer not authenticated
        X509TrustManager trustManager = new X509TrustManager() {
            @Override
     ...
     * @see 若响应消息头中未指定Content-Type属性,则会使用HttpClient内部默认的ISO-8859-1
     */
    public static String sendPostSSLRequest(String reqURL, Map<String, String> params,Map<String,String> headers, String encodeCharset)
        throws Exception {
        String responseContent = "通信失败";
        HttpClient httpClient = new DefaultHttpClient();
        ...
        try {
            ...
            if (statusCode != 200) {
                ...
                if (null != entity) {
                    ...
                    logger.error("Http status:{}, content{}", statusCode, content);
                }
    ...
    public static String sendPostSSLRequest(String reqURL, Map<String, String> params, Map<String,String> headers)
        throws Exception {
        return sendPostSSLRequest(reqURL,params,headers,DEFAULT_CHARSET);
    }


    public static void main(String[] args) {
        String reponse = sendPostSSLRequest("http://1.202.150.5:9080/dv/authentication.do?_t=json", null, "application/json;charset=utf-8", "text/xml;charset=UTF-8");
